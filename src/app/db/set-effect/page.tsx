...
import jsonData from '@/contants/set-effect.json';
...
export default function SetEffectPage() {
      ...
      {effect.name !== '' && (
        <div className="flex flex-col sm:flex-row flex-wrap gap-5">
          <div className="w-[300px] mx-auto">
            <img
              src={`https://jpdkgscyrlhfabjpohmv.supabase.co/storage/v1/object/public/asset/image/set-effect/${effect.index}.png`}
              alt="set effect"
            />
          </div>
